...
- Towards Compute-Aware In-Switch Computing for LLMs Tensor-Parallelism on Multi-GPU Systems, **HPCA**, 2025 (<code style="color : orangered">Multi-GPU超节点架构</code>)
